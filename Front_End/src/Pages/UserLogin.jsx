...
const UserLogin = () => {
  const [buttonValidationForLogin, setButtonValidationForLogin] = useState(
    "outline-primary"
  );
  ...
  const [
    ...
    setButtonTextForForgotPassowrd,
  ] = useState("Change Password");
  const [userIcon, setUserIcon] = useState(true);
  const [showAlert, setShowAlert] = useState(false);
  const [showAlertForPasswordChange, setShowAlertForPasswordChange] = useState(
    false
  );
            ...
            <form ref={formRefForForgotPassword} className="needs-validation">
              ...
              <Form.Control.Feedback type="invalid" className="ms-1">
                <small>
                  <li
                    style={{ fontSize: "10px"}}
                    className="text-danger list-unstyled"
                  >
                  ...
                  <li
                    ...
                    className="text-danger list-unstyled"
                  >
                    <FaTimesCircle style={{ fontSize: "10px" }} /> Atleast 1
                  ...
                  <li
                    ...
                    className="text-danger list-unstyled"
                  >
                    <FaTimesCircle style={{ fontSize: "10px" }} /> Minimum 8 charcater
                  </li>
                </small>
