...
function CarPreview() {
  ...
  const fetchCarData = async (param) => {
    try {
      ...
      const popularCarsPresponse = await axios.post(
        "http://localhost:8181/get-all-cars-for-update"
      );
      console.log(popularCarsPresponse.data);
      setPopularCars(popularCarsPresponse.data);
    } catch (error) {
      console.log(error);
    }
  };
  ...
  const uniquePopularCars = Array.from(
    new Set(popularCars.map((car) => car.carName))
  ).map((carName) => {
    return popularCars.find((car) => car.carName === carName);
  });
  //   For images
  useEffect(() => {
            ...
            <div className="col-sm-12 col-md-6 mt-2">
              ...
              >
                <Button
                  style={{
                    width: "300px",
                    backgroundColor: "rgb(182 99 217 / 89%)",
                    borderColor: "rgb(182 99 217 / 89%)",
                  }}
                >
                  Check On-Road Price
                </Button>
          ...
          <div className="row">
            ...
            >
              ...
              <div className="row mt-4">
                <strong className="mb-3">Popular cars</strong>
                {uniquePopularCars.map((car) => (
                  <div className="col-sm-12 col-md-12">
                    <Link
                      className="text-decoration-none "
                      as={Link}
